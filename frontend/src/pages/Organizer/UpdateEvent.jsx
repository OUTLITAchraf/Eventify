    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-red-50 text-red-600 p-4 rounded-md">
          {submitError || "Failed to load event details"}
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Modify the details for your existing event
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* 💡 Removed static success/error box since toast handles it */}
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-purple-400 transition">
                  ...
                  <label htmlFor="image" className="cursor-pointer block">
                    ...
                    <p className="text-gray-600 font-medium mb-1">
                      Click to upload a new event image
                    </p>
