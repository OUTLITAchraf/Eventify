        ...
        <div className="bg-gradient-to-br from-purple-600 to-indigo-700 p-12 text-white flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-purple-100 text-lg mb-8">
              Sign in to continue discovering and joining amazing events.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Your Events</h3>
                <p className="text-purple-100 text-sm">Access all your registered events</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-purple-100 text-sm">Get recommendations based on your interests</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-purple-100 text-sm">Never miss an update on your favorite events</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-12">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <p className="text-center text-sm text-gray-600 mt-4">
              ...
              <Link to="/register" className="text-purple-600 font-semibold cursor-pointer hover:underline">
                Sign Up
              </Link>
            </p>
          </form>
