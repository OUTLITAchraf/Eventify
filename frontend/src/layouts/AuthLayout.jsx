              ...
              <div className="hidden md:flex items-center gap-8">
                {user ? (
                  ...
                  <>
                    <Link
                      to="/login"
                      className="px-6 py-2 text-purple-600 border-2 border-purple-600 rounded-lg font-semibold hover:bg-purple-50 transition"
                    >
                      Sign In
                    </Link>
                    <Link
                ...
                <div className="flex flex-col gap-4">
                  {user ? (
                    <>
                      ...
                      <button
                        onClick={handleLogout}
                        className="px-6 py-2 text-red-600 border-2 border-red-500 rounded-lg font-semibold hover:bg-red-50 transition"
                      >
                        Logout
                      </button>
                    </>
